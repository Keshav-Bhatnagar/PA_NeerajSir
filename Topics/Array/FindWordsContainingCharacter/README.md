<h2>Find Words Containing Character</h2><h3>Difficulty: Easy</h3><hr><p>You are given a <strong>0-indexed</strong> array of strings <code>words</code> and a character <code>x</code>.</p>
