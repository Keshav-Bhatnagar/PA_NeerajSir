<h2>Insert Greatest Common Divisors in Linked List</h2><h3>Difficulty: Medium</h3><hr><p>Given the head of a linked list <code>head</code>, in which each node contains an integer value.</p>
